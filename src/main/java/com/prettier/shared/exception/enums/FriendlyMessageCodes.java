...
public enum FriendlyMessageCodes implements IFriendlyMessageCode {
    ...
    USER_FOUND(2911),
    USER_LIST_SUCCESSFULLY_CREATED(2912),
    ACTIVE_USER_LIST_SUCCESSFULLY_CREATED(2913),
    INACTIVE_USER_LIST_SUCCESSFULLY_CREATED(2914),
    MANAGER_LIST_SUCCESSFULLY_CREATED(2915),
    MANAGER_NOT_FOUND_EXCEPTION(2916),
    CUSTOMERS_LIST_SUCCESSFULLY_CREATED(2917),
    CUSTOMER_NOT_FOUND_EXCEPTION(2918),
    USER_ROLE_CHANGED(2919),
    USER_STATUS_CHANGED(2920),
    ...
    MESSAGE_NOT_SENT_EXCEPTION(3100),
    MESSAGE_SUCCESSFULLY_SENT(3101),
    MESSAGE_NOT_FOUND_EXCEPTION(3102),
    MESSAGE_SUCCESSFULLY_UPDATED(3103),
    MESSAGE_ALREADY_DELETED(3104),
    MESSAGE_SUCCESSFULLY_DELETED(3105),
    MESSAGE_ALREADY_EXISTS(3106);
